...
misdrijven_2022_2024_clean %>%
  ...
  ggplot(aes(x = factor(jaar), y = misdrijven_per_1000, fill = factor(jaar))) +
  geom_boxplot(outlier.shape = NA) +
  coord_cartesian(ylim = c(0, 150)) +
  scale_y_continuous(breaks = seq(0, 150, by = 25)) +
  theme_minimal() +
  labs(title = "Verdeling misdrijven per 1000 huishoudens",
       x = "Jaar", y = "Misdrijven per 1000 huishoudens", fill = "Jaar")
```
