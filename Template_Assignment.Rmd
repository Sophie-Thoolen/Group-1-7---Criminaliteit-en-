...
```{r}
library(readr)
 Geregistreerde_misdrijven_en_aangiften_soort_misdrijf_gemeente_2026_03062026_142614 <- read_delim("data/Geregistreerde_misdrijven_en_aangiften__soort_misdrijf__gemeente_2026_03062026_142614.csv", delim = ";", escape_double = FALSE, trim_ws = TRUE,skip = 3)
```
