...
```{r}
library(readr)
Vermogen_van_huishoudens_huishoudenskenmerken_regio_indeling_2025_02062026_150256 <- read_delim("data/Vermogen_huishoudens.csv",      delim = ";", escape_double = FALSE, trim_ws = TRUE,skip = 5)
```


```{r loading_data}
dataset <- midwest
vermogen <- read_csv("data/Vermogen_huishoudens.csv")
```
