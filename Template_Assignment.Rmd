...
vermogen_2022_clean <- vermogen_2022 %>%
  ...
  rename(
    regio                = `Regio's`,
    inwoners_x1000          = `x 1 000`,
    percentage           = `%`,
    vermogen_mld         = `mld euro`,
    vermogen_per_persoon = `1 000 euro...5`,
    vermogen_mediaan     = `1 000 euro...6`
  ) %>%
  mutate(across(c(inwoners_x1000, vermogen_mld, vermogen_per_persoon, vermogen_mediaan),
...
vermogen_2024_clean <- vermogen_2024 %>%
  ...
  mutate(across(c(inwoners_x1000, vermogen_mld, vermogen_per_persoon, vermogen_mediaan), ~ as.numeric(str_replace(., ",", ".")))) %>%
  filter(!is.na(vermogen_mld))
