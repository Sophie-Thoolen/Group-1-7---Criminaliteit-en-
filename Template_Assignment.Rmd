...
vermogen_2022_clean <- vermogen_2022 %>%
  ...
  mutate(across(c(aantal_1000, vermogen_mld, vermogen_per_persoon, vermogen_mediaan),
...
vermogen_2024_clean <- vermogen_2024 %>%
  ...
  mutate(across(c(aantal_1000, vermogen_mld, vermogen_per_persoon, vermogen_mediaan), ~ as.numeric(str_replace(., ",", ".")))) %>%
  filter(!is.na(vermogen_mld))
