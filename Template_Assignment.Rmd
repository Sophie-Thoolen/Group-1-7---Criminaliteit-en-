---
title: "De verhouding tussen criminaliteit en vemrogen per gemeente in Nederland"
...
vermogen_2023 <- vermogen_2023 %>%
  mutate(`mld euro` = replace(`mld euro`, `mld euro` == ".", NA))


vermogen_2023_clean <- vermogen_2023 %>%
  mutate(`mld euro` = na_if(`mld euro`, "."),
         `x 1 000` = na_if(`x 1 000`, "."),
         `%` = na_if(`%`, "."),
         `mld euro` = na_if(`mld euro`, "."),
         `1 000 euro...5` = na_if(`1 000 euro...5`, "."),
         `1 000 euro...6` = na_if(`1 000 euro...6`, "."))
...
Vermogen_2024_clean <- X_Vermogen_huishoudens_2024 %>%
  mutate(`mld euro` = na_if(`mld euro`, "."),
         `x 1 000` = na_if(`x 1 000`, "."),
         `%` = na_if(`%`, "."),
         `1 000 euro...5` = na_if(`1 000 euro...5`, "."),
